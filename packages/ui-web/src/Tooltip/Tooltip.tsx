...
export function Tooltip({ children, content, pinOnClick = true, size = "default", side = "top" }: { children: ReactElement; content: ReactNode; pinOnClick?: boolean; size?: "default" | "compact"; side?: "top" | "right" | "bottom" | "left" }) {

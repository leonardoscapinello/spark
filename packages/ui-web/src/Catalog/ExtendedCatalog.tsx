...
export function ExtendedCatalog() {
  ...
  return <>
    ...
    <section className={styles.card}><h2>Modal e painel lateral</h2><div className={styles.row}>
      ...
      <Modal><ModalTrigger render={<Button variant="secondary">Abrir detalhes</Button>} /><ModalContent placement="right" title="Detalhes do contato" description="Painel lateral com rolagem e foco contido." footer={<ModalClose render={<Button>Concluir</Button>} />}><div className={styles.rows}><Field><Label>Nome</Label><Input defaultValue="Contato de demonstração" /></Field><Field><Label>Observações</Label><Textarea placeholder="Escreva uma nota interna" /></Field><Switch defaultChecked>Receber notificações</Switch></div></ModalContent></Modal>
    </div></section>

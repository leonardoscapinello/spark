...
export type ModalContentProps = Omit<ComponentProps<typeof Dialog.Popup>, "title"> & { title: string; description?: string; children: ReactNode; footer?: ReactNode; placement?: "center" | "right" | "left" | "top" | "bottom"; size?: "default" | "wide" | "workspace"; closeDisabled?: boolean; closeLabel?: string };

...
export function ActionModal({open,onOpenChange,title,children,onConfirm,confirmLabel="Confirmar",errorText="Não foi possível concluir. Tente novamente."}:{open:boolean;onOpenChange:(open:boolean)=>void;title:string;children:ReactNode;onConfirm:()=>void|Promise<void>;confirmLabel?:string;errorText?:string}) {

...
export const ConteudoCentralizado: Story = { render: () => <PageFrame width="content"><PageHeader eyebrow="Administração" title="Usuários" description="Gerencie as pessoas com acesso ao sistema." /><p>O título ocupa o painel; o conteúdo mantém uma largura confortável.</p></PageFrame> };

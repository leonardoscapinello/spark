...
export const activities = pgTable(
  ...
  (t) => [
    ...
    check("activities_priority_check", sql`${t.priority} = ANY (ARRAY['none', 'low', 'medium', 'high'])`),
    check("activities_availability_check", sql`${t.availability} = ANY (ARRAY['free', 'busy'])`),

...
> = {
  ...
  business_hours: ["deals:read", "activities:read"],
  holidays: ["deals:read", "activities:read"],
  deals: ["deals:read"],
  ...
  tags: ["contacts:read", "companies:read", "catalog:read"],
  contact_tags: ["contacts:read"],
  company_tags: ["companies:read"],
  product_tags: ["catalog:read"],
  custom_field_options: ["contacts:read", "companies:read", "deals:read"],
  custom_field_values: ["contacts:read", "companies:read", "deals:read"],

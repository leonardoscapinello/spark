...
**The review is done when** all nine steps are in `stepsCompleted`, every reported
finding carries a label and a fix, and the report states how many findings were cut

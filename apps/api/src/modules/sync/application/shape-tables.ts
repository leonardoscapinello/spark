...
export const SHAPE_TABLES: Readonly<Record<SyncResource, ShapeTableConfig>> = {
  ...
  stage_transitions: { column: "org_id" },
  business_hours: { column: "org_id" },
  holidays: { column: "org_id" },
  deals: { column: "org_id" },
  deal_followers: { column: "org_id" },
  ...
  company_registrations: { column: "org_id" },
  company_registration_activities: { column: "org_id" },
  company_registration_members: { column: "org_id" },
  company_registration_tax_regimes: { column: "org_id" },
  whatsapp_templates: { column: "org_id" },
};

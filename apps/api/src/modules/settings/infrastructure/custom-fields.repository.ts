import { Injectable, NotFoundException } from "@nestjs/common"; import { and, eq, sql } from "drizzle-orm"; import { createDbClient, customFieldDefinitions, customFieldOptions, withOrgContext, type SparkDb } from "@spark/db"; import { deriveCustomFieldKey, type CreateCustomFieldInput, type CustomFieldDefinition, type CustomFieldDefinitionId, type OrgId, type UpdateCustomFieldOptionsInput, type UserId } from "@spark/core"; import { DomainEventWriter } from "../../events/application/domain-event-writer.js";

import { Injectable, NotFoundException } from "@nestjs/common"; import { and, eq, sql } from "drizzle-orm"; import { createDbClient, customFieldDefinitions, customFieldOptions, withOrgContext, type SparkDb } from "@spark/db"; import type { CreateCustomFieldInput, CustomFieldDefinition, CustomFieldDefinitionId, OrgId, UpdateCustomFieldOptionsInput, UserId } from "@spark/core"; import { DomainEventWriter } from "../../events/application/domain-event-writer.js";
